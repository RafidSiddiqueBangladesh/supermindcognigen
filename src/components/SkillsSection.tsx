...
const SkillsSection = () => {
  ...
  const developmentServices = [
    {
      ...
      icon: 'Bot',
      description: 'Custom autonomous agents for support, operations, workflows, and product automation.',
      level: 95,
    },
    {
      id: 'service-2',
      name: 'Voice Agent Systems',
      icon: 'Mic',
      description: 'Conversational voice assistants for calls, support flows, and hands-free interactions.',
      level: 93,
    },
    {
      id: 'service-3',
      name: 'Text Agent Systems',
      icon: 'MessageSquareText',
      description: 'Intelligent text-based agents for chat, knowledge search, and task execution.',
      level: 92,
    },
    {
      id: 'service-4',
      name: 'RAG Based Applications',
      icon: 'BookOpen',
      description: 'Retrieval-augmented systems that answer from your own documents, data, and knowledge base.',
      level: 94,
    },
    {
      id: 'service-5',
    ...
    },
    {
      ...
      icon: 'Gamepad2',
      description: 'Interactive games and playable experiences for web, campaigns, and product launches.',
      level: 88,
    },
    {
      id: 'service-8',
      ...
      description: 'Tracking and conversion setup for better ad attribution and campaign optimization.',
      level: 87,
    },
    {
      id: 'service-9',
  ...
  const creativeServices = [
    ...
    {
      id: 'service-19',
      name: 'Cybersecurity Projection',
      icon: 'ShieldCheck',
      description: 'Risk review, security hardening, and protection planning for digital products.',
      level: 89,
    },
    {
      id: 'service-20',
      name: 'Business Projection and Strategy',
      icon: 'BarChart3',
      description: 'Planning, forecasting, and direction support to guide product and agency growth.',
      level: 84,
    },
  ];
